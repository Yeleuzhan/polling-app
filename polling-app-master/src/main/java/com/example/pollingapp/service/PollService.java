...
import com.example.pollingapp.exception.BadRequestException;
import com.example.pollingapp.exception.ResourceNotFoundException;
import com.example.pollingapp.model.*;
import com.example.pollingapp.payload.PagedResponse;
...
import com.example.pollingapp.util.AppConstants;
import com.example.pollingapp.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse castVoteAndGetUpdatePoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        Map<Long, Long> chocesVotesMap = votes.stream()
                .collect(Collectors.toMap(ChoiceVoteCount::getChoiceId, ChoiceVoteCount::getVoteCount));
